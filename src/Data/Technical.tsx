export const tData = [
    ...
    {
        id: 'a21',
        question: 'Explain why the following doesn\'t work as an IIFE: function foo(){ }();. What needs to be changed to properly make it an IIFE? Why?',
        answer: ''
    },
    {
        id: 'a22',
    ...
    {
        id: 'a29',
        question: 'Give an example of an element that is considered a \'block-level\' element? An example of an inline element? What\'s the difference between block-level and inline elements?',
        answer: ''
    },
    {
        id: 'a30',
    ...
    {
        id: 'a31',
        question: 'What is the purpose of article, section, header and footer tags? Please explain with an example and why we should not use divs.',
        answer: ''
    },
    {
        id: 'a32',
    ...
    {
        id: 'a45',
        question: 'Whats the difference between map state to props and map dispatch to props?',
        answer: ''
    },
    {
        id: 'a46',
